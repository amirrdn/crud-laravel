                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <button type="button" class="btn btn-sm btn-primary" id="CreatBook">Create</button>
                            </div>
...
<script type="text/javascript">
    ...
    var t = $('#role-table').DataTable({
        ...
        columns: [
            ...
            {data: 'stock', name: 'stock',searchable: true, sortable : false},
    ...
    $(document).on('click', '#CreatBook',function() {
        CreateBooks();
    });
	...
	function CreateBooks() {
		...
		$('.modal-title').html("Create Books");
		$('#btn-cancel').html("Close");
		$('#btn-save').hide();
		$('.modal-body').load("{{ route('create') }}", function(){
            $('#CreatBooks').modal(
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if (data.fail) {
                    ...
                    toastr.success('Success insert books');
                    t.ajax.reload()
                }
            },
            error: function (xhr, ajaxOptions, thrownError) {
                toastr.error('errors create quotation');
                $('#form .btn-primary').prop('disabled', false);
            }
        });
        return false;
	...
	function EditBooks(id) {
		...
		$('#btn-cancel').html("Close");
		$('#btn-save').hide();
		$('.modal-body').load("{{ url('edit-books') }}/"+id, function(){
            $('#CreatBooks').modal(
                $("#role-table").busyLoad("hide", {
                    spinner: "accordion",
                    color: "red",
    ...
    $(document).on('submit', '#formUpdate',function(e) {
        ...
        $.ajax({
            ...
            error: function (xhr, ajaxOptions, thrownError) {
                toastr.error('errors update books');
                $('#form .btn-primary').prop('disabled', false);
            }
        });
        return false;
